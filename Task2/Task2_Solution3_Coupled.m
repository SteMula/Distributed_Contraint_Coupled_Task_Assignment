%
% DCS MATLAB Project 3, Task 2, Solution 3 (Coupled)
% Distributed Task Assignment for Robotic Networks
% Stefano Mulargia, Stefano Bortolotti
% April 2021
%
%%
% Starting from the decoupled version, we extended the problem to
% the case in which drones are allowed to reach ground tasks.
% 
%%
clear all; 
clc; 
...
number_agent_ground = 3;
number_agent_drones = 7;
